    ...
    return {
        initJQVMAP: function () {
            if (jQuery().vectorMap) {
                var e = function (e) {
                    ...
                    a && (a.width(a.parent().parent().width()),
                    a.show(), a.vectorMap(t), a.hide())
                };
                t("world"), t("usa"), t("europe"), t("russia"),
                t("germany"), e("world"),
        ...
        initCalendar: function () {
            if (jQuery().fullCalendar) {
                var e = new Date,
                    ...
                    i = e.getFullYear(),
                    l = {};
                $("#calendar").width() <= 400 ? ($("#calendar").addClass("mobile"),
                l = {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        $.each(data.data, function (index, value) {
                            if (value.HopDongs.MaTrangThai == "0") {
                                var event = {
                                    title: value.SoHopDong + " \nTài xế: " + ((value.MaTaiXe == null) ? '' + value.TaiXeNgoai + '' : '' + value.TaiXes.HoTen + '') + " \nXe: " + ((value.MaXe == null) ? '' + value.BienSoXe + '' : '' + value.Xes.BienSo + ''),
                                    start: formatDateFromAsp(value.NgayDi),
                                    end: formatDateFromAsp(value.NgayVe),
                                    backgroundColor: App.getBrandColor("blue"),
                                    //url: "http://google.com/",
                                }
                            }
                            else
                                if (value.HopDongs.MaTrangThai == "1") {
                                    var event = {
                                        title: value.SoHopDong + " \nTài xế: " + ((value.MaTaiXe == null) ? '' + value.TaiXeNgoai + '' : '' + value.TaiXes.HoTen + '') + " \nXe: " + ((value.MaXe == null) ? '' + value.BienSoXe + '' : '' + value.Xes.BienSo + ''),
                                        start: formatDateFromAsp(value.NgayDi),
                                        end: formatDateFromAsp(value.NgayVe),
                                ...
                                //else
                                //    if (value.HopDongs.MaTrangThai == "2") {
                                //        var event = {
                                //            title: value.SoHopDong + " \nTài xế: " + ((value.MaTaiXe == null) ? '' + value.TaiXeNgoai + '' : '' + value.TaiXes.HoTen + '') + " \nXe: " + ((value.MaXe == null) ? '' + value.BienSoXe + '' : '' + value.Xes.BienSo + ''),
                                //            start: formatDateFromAsp(value.NgayDi),
                                //            end: formatDateFromAsp(value.NgayVe),
            ...
            if (jQuery.plot) {
                ...
                if (0 != $("#site_statistics").size()) {
                    ...
                    var a = ($.plot($("#site_statistics"),
                        ...
                        {
                            xaxis: {
                                tickLength: 0, tickDecimals: 0, mode: "categories", min: 0,
                                font: {
                                    lineHeight: 14,
                                    style: "normal",
                                    variant: "small-caps",
                ...
                if (0 != $("#site_activities").size()) {
                    var i = null; $("#site_activities_loading").hide(),
                        ...
                        [{
                            ...
                            }],
                            {
                                xaxis: {
                                    ...
                                    ticks: 5, tickDecimals: 0, tickColor: "#eee",
                                    font: {
                    ...
                    $("#site_activities").bind("plothover",
                        function (t, a, l) {
                            if ($("#x").text(a.x.toFixed(2)),
                                $("#y").text(a.y.toFixed(2)), l && i != l.dataIndex) {
                                i = l.dataIndex,
                                $("#tooltip").remove();
                                l.datapoint[0].toFixed(2),
                                l.datapoint[1].toFixed(2);
            ...
            Morris.EventEmitter && $("#sales_statistics").size() > 0 && (dashboardMainChart = Morris.Area({
                ...
                ykeys: ["sales", "profit"],
                labels: ["Sales", "Profit"],
                pointSize: 0, lineWidth: 0, hideHover: "auto",
                resize: !0
            }))
        }, initChat: function () {
            var e = $("#chats"),
                ...
                o = function (a) {
                    ...
                    var l = i.val();
                    if (0 != l.length) {
                        var o = new Date, n = o.getHours() + ":" + o.getMinutes(),
                            r = ""; r += '<li class="out">',
        ...
        initDashboardDaterange: function () {
            ...
            if ("undefined" != typeof AmCharts && 0 !== $("#dashboard_amchart_1").size()) {
                var e = [{
                    date: "2012-01-05",
                    distance: 480, townName: "Miami", townName2: "Miami", townSize: 10, latitude: 25.83, duration: 501
                }, {
                ...
                AmCharts.makeChart("dashboard_amchart_1", {
                    ...
                    categoryField: "date",
                    categoryAxis: {
                        parseDates: !0, minPeriod: "DD", autoGridCount: !1, gridCount: 50, gridAlpha: .1, gridColor: "#FFFFFF",
                        axisColor: "#555555",
                        dateFormats: [{
                            period: "DD", format: "DD"
                        }, {
                    ...
                    valueAxes: [{
                        ...
                        id: "a3", title: "duration", position: "right", gridAlpha: 0,
                        axisAlpha: 0, inside: !0, duration: "mm", durationUnits: { DD: "d. ", hh: "h ", mm: "min", ss: "" }
                    }],
                    graphs: [{
                        id: "g1", valueField: "distance", title: "distance",
                        type: "column", fillAlphas: .7, valueAxis: "a1", balloonText: "[[value]] miles",
                        legendValueText: "[[value]] mi", legendPeriodValueText: "total: [[value.sum]] mi",
                        lineColor: "#08a3cc", alphaField: "alpha"
                    }, {
                        id: "g2", valueField: "latitude", classNameField: "bulletClass",
                        title: "latitude/city", type: "line", valueAxis: "a2", lineColor: "#786c56",
                        lineThickness: 1, legendValueText: "[[description]]/[[value]]",
                        descriptionField: "townName", bullet: "round", bulletSizeField: "townSize",
                        bulletBorderColor: "#02617a", bulletBorderAlpha: 1, bulletBorderThickness: 2,
                        bulletColor: "#89c4f4", labelText: "[[townName2]]", labelPosition: "right",
                        balloonText: "latitude:[[value]]", showBalloon: !0, animationPlayed: !0
                    }, {
                        id: "g3", title: "duration", valueField: "duration", type: "line",
                        valueAxis: "a3", lineAlpha: .8, lineColor: "#e26a6a",
                        balloonText: "[[value]]", lineThickness: 1, legendValueText: "[[value]]",
                        bullet: "square", bulletBorderColor: "#e26a6a", bulletBorderThickness: 1,
                        bulletBorderAlpha: .8, dashLengthField: "dashLength", animationPlayed: !0
                    }],
                    chartCursor: {
                        zoomable: !1, categoryBalloonDateFormat: "DD",
                        cursorAlpha: 0, categoryBalloonColor: "#e26a6a",
                        categoryBalloonAlpha: .8, valueBalloonsEnabled: !1
                    },
                    legend: {
            ...
            if ("undefined" != typeof AmCharts && 0 !== $("#dashboard_amchart_3").size()) {
                AmCharts.makeChart("dashboard_amchart_3", {
                    ...
                    dataProvider: [{
                        ...
                        year: 2014, income: 34.1, expenses: 32.9,
                        dashLengthColumn: 5, alpha: .2,
            ...
            if ("undefined" != typeof AmCharts && 0 !== $("#dashboard_amchart_4").size()) {
                var e = AmCharts.makeChart("dashboard_amchart_4", {
                    type: "pie", theme: "light", path: "../assets/global/plugins/amcharts/ammap/images/",
                    dataProvider: [{
                    ...
                    }], valueField: "value", titleField: "country",
                    outlineAlpha: .4,
                    depth3D: 15,
                ...
                jQuery(".chart-input").off().on("input change", function () {
                    var t = jQuery(this).data("property"),
                        ...
                        i = Number(this.value);
                    e.startDuration = 0,
                    "innerRadius" == t && (i += "%"), a[t] = i, e.validateNow()
                })
            }
